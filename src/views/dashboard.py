...
if st.session_state['authentication_status']:
    ...
    if not sessions_results.empty:
        ...
        sessions_results['data'] = pd.to_datetime(sessions_results['created_at'], dayfirst=True)
        ...
        st.write('Ainda sem resultados. Comece a fazer provas!')